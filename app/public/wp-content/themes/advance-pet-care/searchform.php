...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input id="search-field" type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder','advance-pet-care' ); ?>" value="<?php echo esc_attr( get_search_query()) ?>" name="s">
	</label>
